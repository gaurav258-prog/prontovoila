...
// Split field rendering: for splitIndex=1 fields, render on right side of the split field's rectangle
// The pdfFieldName identifies the split field in the PDF, and splitIndex tells us which column to use
